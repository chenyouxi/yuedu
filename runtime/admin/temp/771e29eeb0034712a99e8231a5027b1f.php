    ...
    <div class="search">
        <form class="form-inline">
            ...
            <a class="btn btn-flat btn-primary m_10" href="https://help.aliyun.com/document_detail/101346.html"
               target="_blank">查看错误码</a>
            <a class="btn btn-flat btn-primary m_10" href="https://help.aliyun.com/document_detail/59210.html"
               target="_blank">使用指引</a>
        </form>
    </div>
    <!--数据表开始-->
    <div class="row">
            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="box-body no-padding">
                        <form method="post" action="<?php echo url('smsPost'); ?>">
                            <!---->
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">AccessKey
                                        ID</label>
                                    <div class="col-xs-8 col-sm-6 col-md-4 col-lg-4">
                                        <input type="text" name="accessKeyId" class="form-control"
                                               placeholder="AccessKeyID" value="<?php echo htmlentities($info['accessKeyId']); ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 dd_ts"><a
                                            href="https://help.aliyun.com/document_detail/53045.html" target="_blank">【创建】</a>
                            ...
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">密钥secret</label>
                                    <div class="col-xs-8 col-sm-6 col-md-4 col-lg-4">
                                        <input type="text" name="accessKeySecret" class="form-control"
                                               placeholder="AccessKeySecret" value="<?php echo htmlentities($info['accessKeySecret']); ?>">
                                    </div>
                            ...
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">签名名称</label>
                                    <div class="col-xs-8 col-sm-6 col-md-4 col-lg-4">
                                        <input type="text" name="signName" class="form-control" placeholder="SignName"
                                               value="<?php echo htmlentities($info['signName']); ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 dd_ts"><a
                                            href="https://help.aliyun.com/document_detail/108072.html" target="_blank">【签名简介】</a><a
                                            href="https://dysms.console.aliyun.com/dysms.htm#/domestic/text/sign"
                                            target="_blank">【查看签名】</a></div>
                                </div>
                            </div>
                            <!---->
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">模版CODE</label>
                                    <div class="col-xs-8 col-sm-6 col-md-4 col-lg-4">
                                        <input type="text" name="templateCode" class="form-control"
                                               placeholder="TemplateCode" value="<?php echo htmlentities($info['templateCode']); ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 dd_ts"><a
                                            href="https://dysms.console.aliyun.com/dysms.htm#/domestic/text/template"
                                            target="_blank">【查看模版】</a></div>
                                </div>
                            </div>
                            <!---->
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <label class="col-xs-4 col-sm-2 col-md-2 col-lg-1 control-label dd_input_l">测试手机</label>
                                    <div class="col-xs-8 col-sm-6 col-md-4 col-lg-4">
                                        <input type="text" name="test_mobile" class="form-control" placeholder="测试手机验证码"
                                               value="<?php echo htmlentities($info['test_mobile']); ?>">
                                    </div>
                                    <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 dd_ts"></div>
                                </div>
                            </div>
                            ...
                            <div class="row dd_input_group">
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-8 col-md-6 col-lg-5 text-center">
                                        ...
                                        <button type="button" id="test_sms" class="btn btn-flat btn-info ">测试发送</button>
                                    </div>
...
<script type="text/javascript">
    $("#test_sms").click(function () {
        var url = "<?php echo url('trySms'); ?>";
        var mobile = $("input[name='test_mobile']").val();
        trySendSms(url, mobile);
    })
</script>
